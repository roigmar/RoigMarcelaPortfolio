const translations = {
    es: {
        ...
        aboutMeP1: "Desarrollador de software con experiencia práctica en C#, Python, Kotlin y Android Studio. Actualmente cursando una Tecnicatura en Desarrollo de Software (IFTS n.° 29).",
        aboutMeP2: "He contribuido a proyectos reales de desarrollo de aplicaciones, colaborando en sistemas de gestión enfocados en la eficiencia, la estructura lógica y la escalabilidad. Mi experiencia en operaciones y compras (más de 10 años) me brinda una ventaja única: comprendo los procesos de negocio, los plazos de entrega y la dinámica de equipo.",
